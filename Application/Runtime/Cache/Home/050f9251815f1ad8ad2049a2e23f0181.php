...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="index_body">
        ...
        <div class="block">
            <form action="<?php echo U('order/orderAdd');?>" method="post" name="theForm" id="theForm" >
        ...
        <?php if(is_array($order_data)): foreach($order_data as $key=>$d): ?><tr>
                ...
                <div class="flowBox">
                    ...
                    <table cellpadding="5" cellspacing="1" width="99%">
                        <tbody>
						<?php if(is_array($location)): foreach($location as $key=>$d): ?><tr>
