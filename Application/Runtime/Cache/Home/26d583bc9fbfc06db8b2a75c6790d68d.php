                            ...
                            <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <input class="inputBg" size="25" name="captcha" id="captcha" type="text" value="" /><img style="cursor: pointer;" onclick="this.src='/Home/Login/verify/t/'+Math.random()" src="<?php echo U('login/verify');?>"/>
...
//                                    },
                ...
                function send_code(){
                    ...
                    if(time==60){
                        ...
                        $.post('<?php echo U("login/sendCode");?>',{'phone':phone},function(){},'json');
                    }
                    if(time==0){
