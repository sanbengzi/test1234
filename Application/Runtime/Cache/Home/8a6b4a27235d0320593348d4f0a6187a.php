            ...
            <div class="AreaR">
                ...
                <div class="box">
                    <div class="box_1">
                        ...
                        <div class="screeBox">
                            <strong>品牌：</strong>
                            <?php if($brand_id): ?><a href="/Home/Goods/goodsList/brand_id/0">全部</a>&nbsp;
                                <?php else: ?>
                                <span>全部</span><?php endif; ?>

                            <?php if(is_array($brandData)): foreach($brandData as $key=>$d): if($brand_id == $d['id']): ?><span><?php echo ($d["brand_name"]); ?></span>&nbsp;
                                    <?php else: ?>
                                    <a href="/Home/Goods/goodsList/brand_id/<?php echo ($d["id"]); ?>"><?php echo ($d["brand_name"]); ?></a>&nbsp;<?php endif; endforeach; endif; ?>
                        </div>
                        <div class="screeBox">
                            <strong>价格：</strong>
                            <?php if($price): ?><a href="/Home/Goods/goodsList/price/0">全部</a>&nbsp;
                                <?php else: ?>
                                <span>全部</span><?php endif; ?>
                            <?php if(is_array($priceData)): foreach($priceData as $k=>$d): if($price == $d): ?><span><?php echo ($d); ?></span>&nbsp;
                                    <?php else: ?>
                                    <a href="/Home/Goods/goodsList/price/<?php echo ($k); ?>"><?php echo ($d); ?></a>&nbsp;<?php endif; endforeach; endif; ?>
                        </div>
                    ...
                    <div class="box_1">
                        ...
                        <form name="compareForm" action="compare.php" method="post" onsubmit="return compareGoods(this);">
                            <div class="clearfix goodsBox" style="border: medium none; padding: 11px 0pt 10px 5px;">
                               <?php if(is_array($goodsData)): foreach($goodsData as $key=>$d): ?><div class="goodsItem">
                                    <a href="<?php echo U('goodsDetail','id='.$d['id']);?>"><img src="/Public/Uploads/<?php echo ($d["goods_bigpic"]); ?>" alt="<?php echo ($d["goods_name"]); ?>" class="goodsimg"></a><br />
                                    <p><a href="<?php echo U('goodsDetail','id='.$d['id']);?>" title="<?php echo ($d["goods_name"]); ?>"><?php echo ($d["goods_name"]); ?></a></p>
