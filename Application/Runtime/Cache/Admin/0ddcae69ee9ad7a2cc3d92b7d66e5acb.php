...
<html>
    ...
    <body>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            <form action="<?php echo U('brandUpdate');?>" method="post" >
                ...
                <tr>
                    ...
                    <td>
                        <select name="cate_id" id="cate">
                            ...
                            <?php if(is_array($cateData)): foreach($cateData as $key=>$d): ?><option value="<?php echo ($d["id"]); ?>" class="cate" <?php echo ($d['id'] == $data['cate_id'] ? selected :''); ?> ><?php echo ($d["cate_name"]); ?></option><?php endforeach; endif; ?>
                        </select>
                    </td>
                </tr>
