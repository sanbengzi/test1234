        ...
        <table height="100%" cellspacing=0 cellpadding=0 width=170
               ...
               <tr>
                <td valign=top align=middle>
                    ...
                    <?php if(is_array($accessData)): foreach($accessData as $key=>$d): ?><table cellspacing=0 cellpadding=0 width=150 border=0>
                    ...
                    <table id=child<?php echo ($d["id"]); ?> style="display: none" cellspacing=0 cellpadding=0
                        ...
                        <?php if(is_array($d['son'])): foreach($d['son'] as $key=>$dd): ?><tr height=20>
                            <td align=middle width=30><img height=9 src="/Public/Admin/img/menu_icon.gif" width=9></td>
                            <td><a class=menuchild href="<?php echo U($dd['menu_controller'].'/'.$dd['menu_action']);?>" target=right><?php echo ($dd["menu_name"]); ?></a></td>
